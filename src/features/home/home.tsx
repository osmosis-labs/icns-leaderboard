...
export const Home = () => {
  ...
  return (
    <div className={classNameHome}>
      <div className="bg-black h-[5em] w-[15em] mt-[5em] flex justify-center items-center shadow-container">
        <img className="" src={logoLetter} alt="logo" />
      </div>

      <div className="relative h-[15em] w-[65em] lg:w-[55em] md:w-[45em] 1.5xs:w-[35em] xs:w-[25em] mt-[5em] bg-black flex justify-center items-center shadow-container">
