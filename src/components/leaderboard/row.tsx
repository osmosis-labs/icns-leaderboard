...
export const Row = ({ name, score, type = "basic", rank }: RowProps) => {
  ...
  if (type === "basic") {
    ...
    classNameRow = `${classNameRow} xs:w-[25em] w-[27.5em] bg-grey-700`;
  } else if (type === "second") {
    classNameRow = `${classNameRow} xs:w-[25em] w-[30em] bg-grey-500`;
  } else if (type === "first") {
    classNameRow = `${classNameRow} xs:w-[25em] w-[35em] bg-grey-300`;
  }
  return (
