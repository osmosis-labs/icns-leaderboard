...
export const Rules = () => {
  return (
    <div className="h-[30em] xs:h-[35em] w-[35em] xs:w-[25em] flex flex-col items-center justify-center bg-black shadow-container relative">
      ...
      <div className="h-full mt-[0em] ">
        <p className="text-text-high p-2 w-full">
          - Base Points: Registering on Day 1 of ICNS launch (Dec 20, 2022) will
          grant you 365 points. Day 2 will be 364 points. And so on.
        </p>
        <p className="text-text-high p-2 w-full">
          - Referral Bonus: You will earn 100 points for every person you refer.
        </p>
        <p className="text-text-high p-2 w-full">
          - Friend of Friends: Every second degree referral (someone you
          referred, refers someone) will earn you 50 points. Every third degree
          referral earns you 33.33 points. Fourth degree referrals are 25
          points. And so on...
        </p>
        <p className="text-text-high p-2 w-full">
          - Referee Points: You will earn 100 points for using someone's
          referral code.
        </p>
